        ...
        <div className={cx("wrapper")}>
            <Container>
                ...
                <Grid container spacing={2}>
                    <Grid className={cx("items")} item xl={4} lg={4} md={12} sm={12} xs={12}>
                    ...
                    <Grid className={cx("items")} item xl={8} lg={8} md={12} sm={12} xs={12}>
                        <div className={cx("item")}>
                            <div className={cx("flex")}>
                                <div className={cx("flexItem")}>
                                    ...
                                    <div className={cx("fontSize80", "colorGray")}>Bình dương</div>
                    ...
                    <Grid className={cx("items")} item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <DataTable
