...
import {checkEmailExists, checkUsernameExists} from "~/services/workspacesService.jsx";
            ...
            <Grid container justifyContent="center">
                <Grid item sm={12} md={6} lg={4} style={{width: "100%"}}>
                    <div className={cx("form-left")}>
                        ...
                        <label className={cx("label-item")}>Nhập lại mật khẩu <span>*</span></label>
                        <TextField
                            ...
                            InputProps={{
                                endAdornment: (<InputAdornment position="end">
                                    ...
                                    >
                                        {formik.values.showConfirmPassword ? <MdOutlineVisibilityOff/> :
                                            <MdOutlineVisibility/>}
                                    </IconButton>
                                </InputAdornment>),
                            }}
                        ...
                        <span
                            className={cx('error')}>{formik.touched.confirmPassword && formik.errors.confirmPassword}</span>
                        ...
                        />
                        <span
                            className={cx('error')}>{formik.touched.numberPhone && formik.errors.numberPhone}
                            </span>
                    </div>
                </Grid>
